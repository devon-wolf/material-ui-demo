// gifs courtesy of KB's API! https://arrested-development-api.herokuapp.com/chicken
export const chickenGifs = [
  {
    id: 1,
  ...
  { id: 5, url: 'https://media.tumblr.com/tumblr_lj6zd2mwbo1qzwuo3.gif' },
  {
    id: 6,
